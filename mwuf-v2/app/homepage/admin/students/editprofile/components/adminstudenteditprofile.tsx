...
const AdminStudentEditProfileForm: React.FC = () => {
    ...
    const fetchStudentData = async () => {
        try {
            const response = await fetch("/api/admin/students/profile", {
                method: "POST",
                headers: {
    ...
    const handleProfileSubmit = async() => {
        ...
        if (studentEmail == newEmail) {
            ...
            try {
                const response = await fetch("/api/admin/students/editprofile", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
