...
import AdminUniversityEditProfileForm from "./components/adminuniversityeditprofile";
          ...
          <div className="flex min-h-screen w-full">
            ...
            <main className = "flex-1 flex flex-col">
              <div className = "sticky top-0 z-50 flex items-center p-4 bg-forest-green shadow-lg">
                  <SidebarTrigger/>
                  <h1 className="ml-4 text-xl font-semibold font-sans">Admin Student Page</h1>
              </div>
              ...
              <div>
                ...
                <div className = "pt-10">
                  <Suspense fallback={
                    ...
                    <AdminUniversityEditProfileForm></AdminUniversityEditProfileForm>
                  </Suspense>
                </div>
              </div>
            </main>
